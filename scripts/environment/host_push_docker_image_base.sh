...
# set PYTHONPATH /home/yangx/miniconda3/lib/python3.9
PYTHONPATH=$PYTHONPATH:$WORK_DIR python3 ./scripts/environment/host_push_docker_image_base.py $WORK_DIR/scripts/config/servers.txt $WORK_DIR/tmp/$DOCKER_IMAGE_BASE_FILENAME
